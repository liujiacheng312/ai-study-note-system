...
INSERT INTO ai_config (id, scope, user_id, provider, mode, api_base_url, api_key, model_name, temperature, mock_on_failure, enabled, remark) VALUES
(1, 'GLOBAL', 0, 'DeepSeek', 'real', 'https://api.deepseek.com/v1', NULL, 'deepseek-chat', 0.30, 1, 1, '管理员可在后台配置全局真实 AI API Key，普通用户也可配置个人 API。');
